...
namespace AssaultBird2454.VPTU.Networking.Server.Command_Handeler
{
    public class Command
    {
        ...
        public Command(string _Name, Type T, Action<object, TcpClientNode> _Callback)
        {
            Name = _Name;
            DataType = T;
            Callback = _Callback;
        ...
        private Action<object, TcpClientNode> Callback { get; } // Callback
        ...
        internal void Invoke(object Data, TcpClientNode node)
        {
