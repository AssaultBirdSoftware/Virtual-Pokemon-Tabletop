namespace AssaultBird2454.VPTU.BattleManager.Data
{
    ...
    /// </summary>
    public enum Status_Afflictions
    {
        Burned = 1,
        Frozen,
        Paralysis,
    ...
    public enum Skills
    {
        ...
        Body_Stealth,
        Body_Survival,
        Mind_GeneralEducation,
        Mind_MedicineEducation,
        Mind_OccultEducation,
        Mind_PokémonEducation,
        Mind_TechnologyEducation,
        Mind_Guile,
        Mind_Perception,
        Spirit_Charm,
        Spirit_Command,
